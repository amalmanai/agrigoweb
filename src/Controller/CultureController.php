...
class CultureController extends AbstractController
{
    ...
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Only persist if not already managed
            if (!$entityManager->contains($culture)) {
        ...
        return $this->render('front/culture/new.html.twig', [
            ...
            'parcelle_choices' => $parcelleRepository->findAllOrderedByName($owner),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, CultureMetricsService $cultureMetricsService, ParcelleRepository $parcelleRepository): Response
    {
        $culture = new Culture();
        $owner = $this->getUser();
        if ($owner instanceof User) {
