...
final class VoiceApiController extends AbstractController
{
    ...
    /**
     * Suggestions de commandes contextuelles basées sur la page actuelle
     */
    ...
    public function getSuggestions(Request $request): JsonResponse
    {
        ...
        $suggestions = match ($page) {
            'tache', 'tasks' => [
                'Créer une tâche Arroser les tomates demain',
                'Lister mes tâches en attente',
                'Terminer la tâche 3',
                'Supprimer la tâche 5'
            ],
            'culture', 'cultures' => [
                'Nouvelle culture de blé dans la parcelle nord',
                'Lister toutes mes cultures',
                'Passer la culture 2 en état floraison',
                'Quel est l\'état de mes cultures ?'
            ],
            'produit', 'stock' => [
                'Ajouter 50 kg d\'engrais azoté',
                'Retirer 10 unités de tomates',
                'Vérifier le stock de pommes',
                'Alertes stock'
            ],
            'vente', 'sales' => [
                'Nouvelle vente 200kg de blé à Monsieur Martin',
                'Lister mes ventes récentes',
                'Statistiques de ventes'
            ],
            'parcelle' => [
                'Créer une nouvelle parcelle Est de 5000 m²',
                'Lister mes parcelles',
                'Météo pour mes parcelles'
            ],
            default => [
                'Aller aux cultures',
                'Créer une tâche',
