 ...
 */
final class Version20260417100318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE alertes_risques ADD severity VARCHAR(10) DEFAULT \'Yellow\' NOT NULL, ADD resolved_at DATETIME DEFAULT NULL, CHANGE is_resolved is_resolved TINYINT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD hosted_domain VARCHAR(255) DEFAULT NULL, DROP is_verified, DROP verification_token_expires_at, CHANGE reset_token reset_token VARCHAR(20) DEFAULT NULL, CHANGE verification_token google_id VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE vente DROP id_user, DROP price, DROP saleDate, DROP sale_date');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE alertes_risques DROP severity, DROP resolved_at, CHANGE is_resolved is_resolved TINYINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT DEFAULT 0 NOT NULL, ADD verification_token VARCHAR(255) DEFAULT NULL, ADD verification_token_expires_at DATETIME DEFAULT NULL, DROP google_id, DROP hosted_domain, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE vente DROP FOREIGN KEY FK_888A2A4CC2C4F051');
        $this->addSql('DROP INDEX IDX_888A2A4CC2C4F051 ON vente');
        $this->addSql('ALTER TABLE vente ADD id_user INT NOT NULL, ADD price NUMERIC(10, 2) DEFAULT NULL, ADD saleDate DATE DEFAULT NULL, ADD sale_date DATETIME DEFAULT NULL');
    }
}
