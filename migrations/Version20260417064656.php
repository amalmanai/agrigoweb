 ...
 */
final class Version20260417064656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP is_verified, DROP verification_token, DROP verification_token_expires_at, CHANGE reset_token reset_token VARCHAR(20) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64912A5F6CC ON user (email_user)');
        $this->addSql('ALTER TABLE vente ADD rating INT DEFAULT NULL, DROP prix, DROP date_vente, DROP id_user, DROP saleDate, CHANGE price price NUMERIC(10, 2) NOT NULL, CHANGE sale_date sale_date DATE NOT NULL, CHANGE buyerName buyer_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT DEFAULT 0 NOT NULL, ADD verification_token VARCHAR(255) DEFAULT NULL, ADD verification_token_expires_at DATETIME DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE vente DROP FOREIGN KEY FK_888A2A4CC2C4F051');
        $this->addSql('DROP INDEX IDX_888A2A4CC2C4F051 ON vente');
        $this->addSql('ALTER TABLE vente ADD prix NUMERIC(10, 2) NOT NULL, ADD date_vente DATE NOT NULL, ADD id_user INT NOT NULL, ADD saleDate DATE DEFAULT NULL, DROP rating, CHANGE price price NUMERIC(10, 2) DEFAULT NULL, CHANGE sale_date sale_date DATETIME DEFAULT NULL, CHANGE buyer_name buyerName VARCHAR(255) DEFAULT NULL');
    }
}
