 ...
 */
final class Version20260417225114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente ADD marketplace_listing TINYINT DEFAULT 1 NOT NULL, ADD available_quantity DOUBLE PRECISION DEFAULT NULL, DROP id_user, DROP price, DROP saleDate, DROP sale_date, DROP rating_comment, DROP buyer_id, CHANGE rating rating INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vente DROP FOREIGN KEY IF EXISTS FK_888A2A4CC2C4F051');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente ADD id_user INT NOT NULL, ADD price NUMERIC(10, 2) DEFAULT NULL, ADD saleDate DATE DEFAULT NULL, ADD sale_date DATETIME DEFAULT NULL, ADD rating_comment LONGTEXT DEFAULT NULL, ADD buyer_id INT DEFAULT NULL, DROP marketplace_listing, DROP available_quantity, CHANGE rating rating SMALLINT DEFAULT NULL');
